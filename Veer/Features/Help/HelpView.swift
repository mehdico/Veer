        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 16) {
                ...
                Group {
                    ...
                    bullet("**⌥Return** pastes as plain text; **⌘C** copies the selected clip without pasting.")
                    bullet("Type to filter the history with fuzzy search — a real search field with a caret and selection. While searching, **⌥← / →** move the caret word-wise instead of navigating.")
