        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 16) {
                ...
                Group {
                    ...
                    bullet("**↓** reveals the actions for the selected clip; **↓** again closes the strip — in both card and list layouts.")
                ...
                Text("Smart actions")
                    .font(.title2)
                    .padding(.top, 8)
                Text("When a clip is exactly a URL, email address, phone number, hex color, or one of the other recognized values, an action strip appears right on the clip — no separate window. Reveal it with **↓**, close it with **↓** or **↑**, and move between actions with **← / →**. Press **Return** to run the highlighted one. Mouse users can right-click a clip and pick from the Smart Actions menu instead. Running any action dismisses the panel; copy actions put the value on the clipboard and return you to your app, ready to paste.")
                Text("Permissions")
                    .font(.title2)
                    .padding(.top, 8)
