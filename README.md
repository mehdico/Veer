...
- Fuzzy search across history, live as you type — a real search field with a caret and selection (⌥←/→ move the caret word-wise while searching).
